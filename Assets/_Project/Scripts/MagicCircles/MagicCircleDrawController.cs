...
namespace DuckovProto.MagicCircles
{
    ...
    public sealed class MagicCircleDrawController : MonoBehaviour
    {
        ...
        public bool IsCastingModeActive => state != DrawState.Idle;
        public bool IsDrawing => state == DrawState.Drawing;
        public string DebugStateLabel
        {
            get
            {
                switch (state)
                {
                    case DrawState.CastingModeActive:
                        return "Magic Circle Ready";

                    case DrawState.Drawing:
                        return "Magic Circle Drawing";
